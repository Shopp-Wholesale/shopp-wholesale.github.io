...
if (!allowed) {
document.body.innerHTML =    <div style="text-align:center;padding:40px;font-family:sans-serif;">   <h2 style="color:#b00">Service Unavailable</h2>   <p>Delivery only within ${SERVICE_RADIUS_KM}km radius.</p>   <button id="admin-login-bypass" style="margin-top:20px;padding:10px;background:#333;color:#fff;border:none;border-radius:5px;">Admin Login</button>   </div>;
